...
public class RequestPermissionsToolImpl implements RequestPermissionsTool {
    ...
    private static final java.lang.String CONFIRMATION_DIALOG = "ConfirmationDialog";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setNegativeButton(android.R.string.cancel,
                            (dialog, which) -> Toast.makeText(getActivity(), R.string.not_avalible, Toast.LENGTH_SHORT).show())
                    .create();
        }
    }
