 ...
 */
    public class BinarizeAsyncTask extends AsyncTask<Uri, Integer, Bitmap[]> {

    private final Context context;
    private BinarizeTaskDelegate delegate;
    ...
    public BinarizeAsyncTask(Context context, BinarizeTaskDelegate delegate)
    {
    ...
    protected Bitmap[] doInBackground(Uri... params) {
        ...
        return new Bitmap[] {background , binarizated};
    }
